...
namespace Mirage.Generators
{
    ...
    public class ShortGeneratorAttribute : GeneratorAttributeBase, IGenerator<short>
    {
        ...
        public ShortGeneratorAttribute(short min, short max) : base(min, max)
        {
        }
        ...
        /// Initializes a new instance of the <see cref="ShortGeneratorAttribute"/> class.
        /// </summary>
        public ShortGeneratorAttribute() : base(short.MinValue, short.MaxValue)
        {
        }
        ...
        {
            return (short)(min + (short)((max - min) * rand.NextDouble()));
        }
