...
namespace Mirage.Generators
{
    ...
    public class NameAttribute : StringGeneratorBase
    {
        ...
        {
            return rand.Next<bool>() ? new MaleNameAttribute(Prefix, MiddleName, LastName, Suffix).Next(rand) : new FemaleNameAttribute(Prefix, MiddleName, LastName, Suffix).Next(rand);
        }
    }
}