...
{
    public class NullableBoolGenerator : TestBaseClass<NullableBoolGeneratorAttribute>
    {
        public NullableBoolGenerator()
        {
            TestObject = new NullableBoolGeneratorAttribute();
        }
