...
{
    public class NullableULongGeneratorTests : TestBaseClass<NullableULongGeneratorAttribute>
    {
        public NullableULongGeneratorTests()
        {
            TestObject = new NullableULongGeneratorAttribute();
        }
