...
{
    public class MaleFirstNameAttributeTests : TestBaseClass<MaleFirstNameAttribute>
    {
        public MaleFirstNameAttributeTests()
        {
            _testClass = new MaleFirstNameAttribute();
        }

        private readonly MaleFirstNameAttribute _testClass;
        ...
        {
            // Act
            var instance = new MaleFirstNameAttribute();
